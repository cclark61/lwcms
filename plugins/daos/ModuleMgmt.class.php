...
class ModuleMgmt
{
	...
	//************************************************************
	public static function install_files($source_dir, $dest_dir)
	{
		$num_errors = 0;
	    	...
	    	foreach ($objects as $object) {
		    	if ($object != "." && $object != "..") {
			    	...
			    	if (is_dir($full_object)) {
			    		$num_errors += self::rrmdir($full_object);
			    	}
			    	else {
	...
	//************************************************************
	public static function check_uninstall_dirs($phrase)
	{
		$num_errors = 0;
	...
	//************************************************************
	public static function check_module_package()
	{
