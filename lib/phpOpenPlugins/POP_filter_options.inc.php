...
* @version 		Started: 2/19/2007, Last updated: 7/17/2012
**/
//*****************************************************************************
//*****************************************************************************
...
//=============================================================================
//=============================================================================
function save_and_return_filter_data(&$current_page, $request_index, $cookie_index, $default)
{
...
//=============================================================================
//=============================================================================
function create_select_filter($select_vals, $url_stub, $selected="-1", $label="")
{	
	// Label
...
//=============================================================================
//=============================================================================
function print_list_filter(&$page, $base_url, $options, $get_var, $cookie_mod_var, $label)
{
	$ret_vals = array();
	...
	print new gen_element('label', $label) . "\n";
	ob_start();
	foreach ($options as $key => $option) {
		...
		$o = new gen_element("option", $option["display"], $o_attrs);
		$o->render();
	}
	
	$select = new gen_element("select", ob_get_clean(), array("class" => "filter"));
	$select->render();
