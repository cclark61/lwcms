...
// Set Plugin Folders
//************************************************
set_plugin_folder(dirname(__FILE__) . '/lib/phpOpenPlugins');
...
if (isset($_SESSION['change_password'])) {
	$_SESSION['change_password'] = (strtolower($_SESSION['change_password']) == 'yes') ? (1) : (0);
}
else { $_SESSION['change_password'] = 1; }

//************************************************
// Help Page Functionality
//************************************************
if (isset($_SESSION['help_page'])) {
	$_SESSION['help_page'] = (strtolower($_SESSION['help_page']) == 'yes') ? (1) : (0);
}
else { $_SESSION['help_page'] = 0; }
