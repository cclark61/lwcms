...
$sql_updates[48][] = "UPDATE `app_modules` SET `image` = 'fa fa-user' WHERE `app_modules`.`phrase` = 'static_content' LIMIT 1;";
$sql_updates[48][] = "UPDATE `app_modules` SET `image` = 'fa fa-file-text-o' WHERE `app_modules`.`phrase` = 'authors' LIMIT 1;";
